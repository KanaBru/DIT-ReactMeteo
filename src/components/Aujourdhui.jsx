...
import { emojis } from "../fonctions/emojis";
import { formatDateToHoursMinutes } from "../fonctions/formatDateToHoursMinutes";
import { getEmojis } from "../fonctions/getEmojis";

const Aujourdhui = ({ data, weatherUnits }) => {
